  ...
  return (
    <Flex flexDir={'column'} alignItems={'center'}>
      ...
      <Container marginBottom={"2rem"} maxW={"none"} border={'1px solid #ffffffde'} borderRadius={'20px'} padding={'1rem'}>
        ...
        <Text pt={'1rem'} color={"#ffffffde"}>
          We are given a system of equations that can be expressed as either a matrix equation or a multivariate function. Using the method of gradient descent we can find the minimum of the multivariate function, thus solving the system of equations.
        </Text>
      </Container>
